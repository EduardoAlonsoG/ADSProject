<div class="container__all">
  <div class="headerBox container">
    <header class="header">
      ...
      <a class="header__btnRedirect" href="<?php echo SERVER_URL; ?>/login">INICIAR SESION</a>
    </header>
  </div>
  <div class="presentation">
    <p class="pres__text"><span>TT DEPLOYER</span></p>
    <!--<p class="pres__paragraph">Esta página muestra información perteneciente a ESCOM. Presentamos los diversos proyectos realizados por los egresados de nuestra institución con la finalidad de poner dicho contenido a disposición de la población en general e interesados y sirva de fuente o referencia.
    </p>-->
