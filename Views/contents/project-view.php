...
<main class="main">
  ...
  <div class="detailsResult">
    ...
    if ($_SESSION['tipo'] == USER_TYPE['student']) {
      ...
      echo '
        <i class="detailsResult__qualification">Calificación de Proyecto: ' . $nota . '</i>
        ';
    }
    ?>
  </div>
  <div class="proyect__allContent">
    ...
    <aside class="observationsBox">
      <div class="observations">
        <span class="observations__subtitle"><i class="ph ph-eye"></i> Comentarios</span>
        <div class="observations__content">
          <b>Comentarios del proyecto</b>
