  ...
  <!--<aside class="filter">
    <div class="filter__group">
      ...
      <nav class="filter__nav">
        <ul>
          <li><a class="nav__item" href="">Ing Sistemas Computacionales <span class="nav__item__count">1</span></a></li>
          <li><a class="nav__item" href="">Ing Inteligencia Artificial <span class="nav__item__count">2</span></a></li>
          <li><a class="nav__item" href="">Lic Ciencia de Datos <span class="nav__item__count">3</span></a></li>
          <li><a class="nav__item" href="">Ing Computacion <span class="nav__item__count">4</span></a></li>
          <li><a class="nav__item" href="">Ing Electrica <span class="nav__item__count">5</span></a></li>
        </ul>
      </nav>
    </div>
  </aside>-->
